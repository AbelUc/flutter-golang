...
class EditTask extends StatelessWidget {
  Map<String, dynamic> myData;
   EditTask( {Key? key, required this.myData}) : super(key: key);
        ...
        child: Center(
          child: Container(
            ...
            child: GetBuilder<DataController>(builder: (controller){
              nameController.text = '${myData['task']}';
              detailController.text='${myData['task_detail']}';
              return Column(
                  ...
                  Column(
                    children: [
                      ...
                      TextFieldWidget(
                          ...
                          textHint: "Task detail", maxLine: 3,borderRadius: 15,),
                      const SizedBox(
                        height: 20,
                      ),
                      InkWell(
                        onTap: () {
                          if(_dataValidation()){
                            Get.find<DataController>().updateData(int.parse(myData["id"].toString()),nameController.text.trim(),
